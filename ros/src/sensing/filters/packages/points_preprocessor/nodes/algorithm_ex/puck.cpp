...
void PuckAlgorithm::ConfigCallback(const autoware_msgs::ConfigRingGroundFilterConstPtr &config)
{
...
void PuckAlgorithm::ConfigCallback16(const autoware_msgs::ConfigRingGroundFilterConstPtr &config)
{
