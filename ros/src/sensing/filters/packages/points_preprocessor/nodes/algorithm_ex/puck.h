...
#include "autoware_config_msgs/ConfigRingGroundFilter.h"
...
//    gap_thres_= 0.15;
    ...
    void ConfigCallback(const autoware_config_msgs::ConfigRingGroundFilterConstPtr &config);
    void ConfigCallback16(const autoware_config_msgs::ConfigRingGroundFilterConstPtr &config);
